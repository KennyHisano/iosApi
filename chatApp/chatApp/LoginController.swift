...
class LoginController: UIViewController {
    ...
    lazy var loginRegisterButton: UIButton = {
        ...
        button.backgroundColor = UIColor(r: 80, g: 101, b: 141)
    ...
    lazy var profileImageView: UIImageView = {
        ...
        imageView.image = UIImage(named: "imageSamp")
    ...
    override func viewDidLoad() {
        ...
        backgroundImage.image = UIImage(named: "volcano-night-sky-iphone-wallpaper")
    ...
    func setupLoginRegisterSegmentedControl() {
        ...
        loginRegisterSegmentedControl.bottomAnchor.constraintEqualToAnchor(inputsContainerView.topAnchor, constant: -10).active = true
    ...
    func setupProfileImageView() {
        ...
        profileImageView.bottomAnchor.constraintEqualToAnchor(loginRegisterSegmentedControl.topAnchor, constant: -15).active = true
    ...
    func setuplogoImageView() {
        ...
        logoImageView.bottomAnchor.constraintEqualToAnchor(profileImageView.topAnchor, constant: -15).active = true
    ...
    func setupInputsContainerView() {
        ...
        inputsContainerView.widthAnchor.constraintEqualToAnchor(view.widthAnchor, constant: -10).active = true
    ...
    func setupLoginRegisterButton() {
        ...
        loginRegisterButton.topAnchor.constraintEqualToAnchor(inputsContainerView.bottomAnchor, constant: 15).active = true
